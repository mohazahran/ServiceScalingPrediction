...
class learn_genericQueue_bernoulli(nn.Module):
    ...
    def objective(self, logPK, inputRates, actualDrops):
        ...
        steady_state_loss = F.mse_loss(torch.mm(F.softmax(self.pi), self.P), F.softmax(self.pi))
